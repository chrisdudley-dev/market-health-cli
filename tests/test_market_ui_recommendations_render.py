...
def test_recommendation_lines_from_contract_noop():
    rec = json.loads(Path("tests/fixtures/scenarios/bullish/jerboa_cache/recommendations.v1.json").read_text(encoding="utf-8"))
    contract = {"summary": {"recommendations_status": "ok"}, "data": {"recommendations": rec}}
